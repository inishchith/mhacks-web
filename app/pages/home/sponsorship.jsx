    ...
    render() {
        return (
            <div>
                ...
                <SectionBody>
                    {' '}
                    Interested in sponsoring? Want more information? Our next major event will be in the Fall and we'd love to hear from you! Shoot us an email at kevin@mhacks.org.
                    {' '}
                </SectionBody>
            </div>
        );
